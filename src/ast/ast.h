...
// Macro for rewriting things; `GET` is the expression to be rewritten;
// `SET` is a command that should do the rewriting, i.e. something
// sensible with the variable called `replacement`.
